...
# Path to .config_file
config_file_path <- file.path(base_path, "data", ".config_file")

# Read config file
readRenviron(config_file_path)
...
# Import modules
source(paste0(base_path,"/modules/login.R"))
source(paste0(base_path,"/modules/sidebar.R"))
source(paste0(base_path,"/modules/module_annotation.R"))
source(paste0(base_path,"/modules/module_adminvalidation.R"))
source(paste0(base_path,"/modules/module_users.R"))
source(paste0(base_path,"/modules/module_config.R"))
source(paste0(base_path,"/modules/module_projectcreation.R"))
source(paste0(base_path,"/modules/module_gazzeteercreation.R"))
source(paste0(base_path,"/modules/module_gazzeteerview.R"))
...
use_virtualenv(paste0(base_path,"/scilinker_py_env/")) 

#Import python functions
source_python(paste0(base_path,'/python/gaz_functions.py'))
source_python(paste0(base_path,'/python/proj_functions.py'))
